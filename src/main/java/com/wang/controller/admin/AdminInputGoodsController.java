...
@Controller
@RequestMapping("/adminInputGoods")
public class AdminInputGoodsController {
    @Autowired
    ...
    public String editInputGoods(InputGoods inputGoods,Model model){
        ...
        return "admin/editInputGoods";
    }

    //	按条件获取所有进货信息
    @RequestMapping("getInputGoodsByCondition")
    public String getInputGoodsByCondition(HttpServletRequest request, Model model,
