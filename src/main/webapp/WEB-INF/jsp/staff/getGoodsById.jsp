...
<form class="form-horizontal form-label-left" novalidate>
    ...
    <a href="${pageContext.request.contextPath }/goods/editGoods?goodsId=${goods.goodsId}" class=" text-center btn btn-primary  col-md-offset-4 col-lg-offset-4col-xl-offset-4" role="button">修改</a>
