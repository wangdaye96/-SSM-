...
<form class="form-horizontal form-label-left" novalidate>
    ...
    <a href="${pageContext.request.contextPath }/order/getAllOrderInfo" class=" text-left btn btn-default  " role="button">返回上页</a>
    <a href="${pageContext.request.contextPath }/order/editOrder?orderId=${order.orderId}" class=" text-center btn btn-primary  col-md-offset-4 col-lg-offset-4col-xl-offset-4" role="button">修改</a>
