...
<form class="form-horizontal form-label-left" method="post" action="update" onsubmit="return checkAll()">
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="staffId" name="staffId" class="form-control input-small input-sm "
                   value="${staff.staffId}" type="text" readonly>
        </div>
    </div>
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="staffName" name="staffName" class="form-control col-md-7 col-xs-5"
                   value="${staff.staffName}" type="text" onblur="checkName()"><span id="demo1"></span>
        </div>
    </div>
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="idcard" name="idcard" class="form-control col-md-7 col-xs-5" value="${staff.idcard}"
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="identity" name="identity" class="form-control col-md-7 col-xs-5"
                   value="${staff.identity}" type="text">
        </div>
    </div>
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="password" name="password" class="form-control col-md-7 col-xs-5"
                   value="${staff.password}" type="password" placeholder="请填写密码">
        </div>
    </div>
    <div class="item form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-5">密码<span>*</span>
