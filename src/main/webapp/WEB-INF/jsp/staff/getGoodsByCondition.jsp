...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
                            ...
                            <th>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="${pageContext.request.contextPath }/goods/getGoodsById?goodsId=${goods.goodsId}" >查看</a></li>
                                        <li><a href="${pageContext.request.contextPath }/goods/editGoods?goodsId=${goods.goodsId}">修改</a></li>
                                    </ul>
                                </div>
                                <a href="${pageContext.request.contextPath }/goods/deleteGoods?goodsId=${goods.goodsId}"  class="btn btn-danger btn-xs" aria-label="Left Align" role="button">删除</a>
                            </th>
                        </tr>
                    </c:forEach>
                </table>
        ...
        <a href="${pageContext.request.contextPath }/goods/getAllGoodsList" class=" text-left btn btn-default  " role="button">返回上页</a>
    </div>
</div>
