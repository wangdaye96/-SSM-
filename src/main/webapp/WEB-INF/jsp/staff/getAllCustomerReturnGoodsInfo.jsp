            ...
            <form class="form-inline" action="getCustomerReturnGoodsByCondition" method="post">
                ...
                <span class="row">
								 <div class="form-group">
								  ...
								  <a href="${pageContext.request.contextPath }/CustomerReturnGoods/toAdd" class="btn btn-primary " role="button">新增</a>
								  </span>
            </form>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li><a href="${pageContext.request.contextPath }/CustomerReturnGoods/getAllCustomerReturnGoodsInfo?pn=1">首页</a></li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <li><a href="${pageContext.request.contextPath }/CustomerReturnGoods/getAllCustomerReturnGoodsInfo?pn=${pageInfo.pageNum-1}"
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <li><a href="${pageContext.request.contextPath }/CustomerReturnGoods/getAllCustomerReturnGoodsInfo?pn=${page_Num }">${page_Num }</a></li>
                            </c:if>
                        ...
                        <li><a href="${pageContext.request.contextPath }/CustomerReturnGoods/getAllCustomerReturnGoodsInfo?pn=${pageInfo.pages}">末页</a></li>
                    </ul>
                </nav>
            </div>
        </div>
