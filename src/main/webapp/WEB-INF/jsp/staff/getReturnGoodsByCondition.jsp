                ...
                <table id="datatable" class="table table-striped table-bordered table-hover">
                    ...
                    <c:forEach items="${pageInfo.list}" var="returnGoods">
                        <tr>
                            ...
                            <th>
                                <a href="${pageContext.request.contextPath }/returnGoods/edit?inputId=${returnGoods.returnId}" class="btn btn-primary btn-xs">修改</a>
...
<script type="text/javascript">
    function del(id) {
        ...
        if (message==true) {
            // 确认时做的操作 var
            window.location.href="${pageContext.request.contextPath }/returnGoods/delete?inputId="+id;
            alert("删除成功");
        } else {
            // 取消时做的操作
            alert("删除失败");
