...
<form class="form-horizontal form-label-left" method="post" action="updateOrder" onsubmit="return checkall()">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="orderId" name="orderId" class="form-control input-small input-sm "  value="${order.orderId}"  type="text" readonly="readonly"  >
        </div>
    </div>
    <div class="item form-group">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="number" name="number" class="form-control col-md-7 col-xs-5" value="${order.number}"  type="number" onkeyup="total()" onblur="checknum()"><span id="demo5" style="color: red;"></span>
        </div>
    </div>
    <div class="item form-group">
