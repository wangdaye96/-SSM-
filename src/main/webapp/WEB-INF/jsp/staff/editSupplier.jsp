...
<form class="form-horizontal form-label-left" method="post" action="updateSupplier" onsubmit="return checkall()">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="supId" name="supId"  class="form-control col-md-7 col-xs-5" value="${supply.supId}" readonly="readonly" type="text"><span id="demo1" style="color: red;"></span>
        </div>
    </div>
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="supName"  name="supName" class="form-control col-md-7 col-xs-5"  value="${supply.supName}" type="text"  onblur="checkname()"><span id="demo2" style="color: red;"></span>
        </div>
    </div>
    <div class="item form-group">
    ...
    <a href="${pageContext.request.contextPath }/supplier/getAllSupplierInfo" class=" text-left btn btn-default  " role="button">返回上页</a>
