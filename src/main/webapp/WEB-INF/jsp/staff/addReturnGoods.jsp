...
<form class="form-horizontal form-label-left" method="post" action="insert" onsubmit="return checkAll()">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="returnId" name="returnId" class="form-control input-small input-sm " type="text" value=""><span id="demo1" style="color: red;"></span><span>${rrr}</span>
        </div>
    </div>
    <div class="item form-group">
    ...
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="number" name="number" class="form-control col-md-7 col-xs-5" type="text" value="0" onblur="checknum()"><span id="demo4" style="color: red;"></span><span>${ReturnNumberError}</span>
        </div>
    </div>
    <div class="item form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-5">
            <input id="inputDate"  name="inputDate" class="form-control col-md-7 col-xs-5" value="<fmt:formatDate pattern="yyyy-MM-dd" value=""/>" type="date" >
        </div>
    </div>
    <div class="item form-group">
...
<script>
    ...
    /* 校验整个表单 */
    function checkAll(){
        let inputId=checkreturnId();
        let name = checkName();
        let goodsId=checkGoodsId();
        let num=checknum();

        if(inputId&&name&&goodsId&&num){
            alert("添加中");
            return true;
        }else{
            alert("添加失败，请重新填写数据");
...
<script src="${pageContext.request.contextPath}/staticResource/local_js/addReturnGoods.js"></script>