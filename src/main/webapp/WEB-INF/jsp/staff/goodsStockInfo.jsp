                    ...
                    <c:forEach items="${pageInfo.list}" var="goodsStock">
                        <tr>
                            ...
                            <th>
                                ...
                                <a href="${pageContext.request.contextPath}/goodsStock/toUpdate?goodsId=${goodsStock.goodsId}"
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li><a href="${pageContext.request.contextPath }/goodsStock/getAllGoodsStock?pn=1">首页</a></li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <li>
                                <a href="${pageContext.request.contextPath }/goodsStock/getAllGoodsStock?pn=${pageInfo.pageNum-1}"
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <li>
                                    <a href="${pageContext.request.contextPath }/goodsStock/getAllGoodsStock?pn=${page_Num }">${page_Num }</a>
                                </li>
                            </c:if>
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath }/goodsStock/getAllGoodsStock?pn=${pageInfo.pages}">末页</a>
                        </li>
                    </ul>
                </nav>
            </div>
