                    ...
                    <c:forEach items="${pageInfo.list}" var="input">
                        <tr>
                            ...
                            <th>
                                ...
                                <a href="${pageContext.request.contextPath }/adminInputGoods/editInputGoods?inputId=${input.inputId}" class="btn btn-primary btn-xs">修改</a>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li><a href="${pageContext.request.contextPath }/adminInputGoods/getAllInputGoods?pn=1">首页</a></li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <li><a href="${pageContext.request.contextPath }/adminInputGoods/getAllInputGoods?pn=${pageInfo.pageNum-1}"
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <li><a href="${pageContext.request.contextPath }/adminInputGoods/getAllInputGoods?pn=${page_Num }">${page_Num }</a></li>
                            </c:if>
                        ...
                        <li><a href="${pageContext.request.contextPath }/adminInputGoods/getAllInputGoods?pn=${pageInfo.pages}">末页</a></li>
                    </ul>
                </nav>
            </div>
        </div>
...
<script type="text/javascript">
    function del(id) {
        ...
        if (message==true) {
            // 确认时做的操作 var
            window.location.href="${pageContext.request.contextPath }/adminInputGoods/delete?inputId="+id;
            alert("删除成功");
        } else {
            // 取消时做的操作
            alert("删除失败");
