            ...
            <form class="form-inline" action="getOrderByCondition" method="post">
                ...
                <span class="row">
								 ...
								 <div class="form-group" class="col-xs-1">
								  ...
								  <a href="${pageContext.request.contextPath }/adminOrder/toAddOrder" class="btn btn-primary " role="button">新增</a><span id="demo2" style="color: red"></span>
								  </span>
                ...
                <table id="datatable" class="table table-striped table-bordered table-hover">
                    ...
                    <c:forEach items="${pageInfo.list}" var="order">
                        <tr>
                            ...
                            <th>${order.remarks}</th>
                            <th>
                                <a href="${pageContext.request.contextPath }/adminOrder/getOrderById?orderId=${order.orderId}" class="btn btn-primary btn-xs" >查看</a>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li><a href="${pageContext.request.contextPath }/adminOrder/getAllOrderInfo?pn=1">首页</a></li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <li><a href="${pageContext.request.contextPath }/adminOrder/getAllOrderInfo?pn=${pageInfo.pageNum-1}"
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <li><a href="${pageContext.request.contextPath }/adminOrder/getAllOrderInfo?pn=${page_Num }">${page_Num }</a></li>
                            </c:if>
                        ...
                        <li><a href="${pageContext.request.contextPath }/adminOrder/getAllOrderInfo?pn=${pageInfo.pages}">末页</a></li>
                    </ul>
                </nav>
            </div>
        </div>
...
<script type="text/javascript">
    function del(id) {
        ...
        if (message==true) {
            // 确认时做的操作 var
            window.location.href="${pageContext.request.contextPath }/adminOrder/delete?orderId="+id;
            alert("删除成功");
        } else {
            // 取消时做的操作
            alert("删除失败");
