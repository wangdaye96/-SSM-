                            ...
                            <th>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="${pageContext.request.contextPath }/adminGoods/getGoodsById?goodsId=${goods.goodsId}" >查看</a></li>
                                        <li><a href="${pageContext.request.contextPath }/adminGoods/editGoods?goodsId=${goods.goodsId}">修改</a></li>
                                    </ul>
                                </div>
                                <a href="${pageContext.request.contextPath }/adminGoods/deleteGoods?goodsId=${goods.goodsId}"  class="btn btn-danger btn-xs" aria-label="Left Align" role="button">删除</a>
                            </th>
                        </tr>
                    </c:forEach>
                </table>
