        ...
        <div class="row">
            <form class="form-inline" action="getGoodsByCondition" method="post">
                ...
                <span class="row">
								  ...
								  <a href="${pageContext.request.contextPath }/adminGoods/toAddGoods"
                            ...
                            <th>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="${pageContext.request.contextPath }/adminGoods/getGoodsById?goodsId=${goods.goodsId}">查看</a>
                                        </li>
                                        <li>
                                            <a href="${pageContext.request.contextPath }/adminGoods/editGoods?goodsId=${goods.goodsId}">修改</a>
                                        </li>
                                    </ul>
                                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li><a href="${pageContext.request.contextPath }/adminGoods/getAllGoodsList?pn=1">首页</a></li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <li>
                                <a href="${pageContext.request.contextPath }/adminGoods/getAllGoodsList?pn=${pageInfo.pageNum-1}"
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <li>
                                    <a href="${pageContext.request.contextPath }/adminGoods/getAllGoodsList?pn=${page_Num }">${page_Num }</a>
                                </li>
                            </c:if>
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath }/adminGoods/getAllGoodsList?pn=${pageInfo.pages}">末页</a>
                        </li>
                    </ul>
                </nav>
            </div>
...
<script type="text/javascript">
    function del(id) {
        ...
        if (message == true) {
            // 确认时做的操作 var
            window.location.href = "${pageContext.request.contextPath }/adminGoods/deleteGoods?goodsId=" + id;
            alert("删除成功");
        } else {
            // 取消时做的操作
            alert("删除失败");
