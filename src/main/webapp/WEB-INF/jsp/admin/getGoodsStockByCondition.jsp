...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
                    ...
                    <c:forEach items="${pageInfo.list}" var="goodsStock">
                        <tr>
                            ...
                            <th>
                                ...
                                <a href="${pageContext.request.contextPath}/adminGoodsStock/toUpdate?goodsId=${goodsStock.goodsId}" class="btn btn-primary btn-xs">进货</a>
        ...
        <a href="${pageContext.request.contextPath }/adminGoodsStock/getAllGoodsStock" class=" text-left btn btn-default  " role="button">返回上页</a>
    </div>
</div>
