            ...
            <form class="form-inline" action="getReturnGoodsByCondition" method="post">
                ...
                <span class="row">
								 <div class="form-group">
								  ...
								  <a href="${pageContext.request.contextPath }/adminReturnGoods/toAdd" class="btn btn-primary " role="button">新增</a>
								  </span>
            </form>
        </div>
        <div class="row">
                ...
                <table id="datatable" class="table table-striped table-bordered table-hover">
                    ...
                    <c:forEach items="${pageInfo.list}" var="returnGoods">
                        <tr>
                            ...
                            <th>
                                <a href="${pageContext.request.contextPath }/adminReturnGoods/edit?returnId=${returnGoods.returnId}" class="btn btn-primary btn-xs">修改</a>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li><a href="${pageContext.request.contextPath }/adminReturnGoods/getAllReturnGoods?pn=1">首页</a></li>
                        <c:if test="${pageInfo.hasPreviousPage }">
                            <li><a href="${pageContext.request.contextPath }/adminReturnGoods/getAllReturnGoods?pn=${pageInfo.pageNum-1}"
                        ...
                        <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                            ...
                            <c:if test="${page_Num != pageInfo.pageNum }">
                                <li><a href="${pageContext.request.contextPath }/adminReturnGoods/getAllReturnGoods?pn=${page_Num }">${page_Num }</a></li>
                            </c:if>
                        ...
                        <li><a href="${pageContext.request.contextPath }/adminReturnGoods/getAllReturnGoods?pn=${pageInfo.pages}">末页</a></li>
                    </ul>
                </nav>
            </div>
        </div>
...
<script type="text/javascript">
    function del(id) {
        ...
        if (message===true) {
            // 确认时做的操作 var
            window.location.href="${pageContext.request.contextPath }/adminReturnGoods/delete?returnId="+id;
            alert("删除成功");
        } else {
            // 取消时做的操作
            alert("删除失败");
