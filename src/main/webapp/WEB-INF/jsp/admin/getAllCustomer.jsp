    ...
    <div class="x_panel">
        ...
        <div class="row">
            <form class="form-inline" action="getCustomerByCondition" method="post">
								  ...
								  <a href="${pageContext.request.contextPath }/adminCustomer/toAdd" class="btn btn-primary " role="button">新增</a>
								  </span>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath }/adminCustomer/getAllCustomer?pn=1">首页</a></li>
                            <c:if test="${pageInfo.hasPreviousPage }">
                                <li><a href="${pageContext.request.contextPath }/adminCustomer/getAllCustomer?pn=${pageInfo.pageNum-1}"
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                ...
                                <c:if test="${page_Num != pageInfo.pageNum }">
                                    <li><a href="${pageContext.request.contextPath }/adminCustomer/getAllCustomer?pn=${page_Num }">${page_Num }</a></li>
                                </c:if>
                            ...
                            <li><a href="${pageContext.request.contextPath }/adminCustomer/getAllCustomer?pn=${pageInfo.pages}">末页</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
